...
async fn run_menu() -> Result<()> {
    ...
    crate::ui::theme::apply_saved_theme(); // opencode-style persisted TUI theme
    crate::ui::layout::apply_saved_layout(); // opencode-style persisted TUI layout
...
pub(crate) fn status_text(history: &[Message], model: &str) -> String {
