...
Builtin {
    ...
    Builtin {
        id: SlashId::Theme,
        name: "theme",
        aliases: &[("themes", "alias for /theme")],
        hidden_aliases: &[],
        hidden: false,
        description: "pick the TUI colour theme (opencode-style)",
        argument_hint: "[name|list]",
        help: "bare /theme: arrow-key picker. list: show built-in + custom ~/.aizen/themes/*.json themes. /theme <name>: switch live (persisted in cli-config.json)",
        stdin: Stdin::WhenBare,
    },
    Builtin {
        id: SlashId::Layout,
        name: "layout",
        aliases: &[("layouts", "alias for /layout")],
        hidden_aliases: &[],
        hidden: false,
        description: "pick the TUI layout density (opencode-style)",
        argument_hint: "[default|dense|list|<name>]",
        help: "bare /layout: arrow-key picker. default/polished/dense/spacious/auto. Custom layouts live in ~/.aizen/layout/*.{json,jsonc}",
        stdin: Stdin::WhenBare,
    },
    Builtin {
        id: SlashId::Preset,
        name: "preset",
        aliases: &[("presets", "alias for /preset")],
        hidden_aliases: &[],
        hidden: false,
        description: "apply a coordinated theme + layout preset",
        argument_hint: "[list|name]",
        help: "list: show presets. polished: moonlight + polished. midnight: tokyonight + spacious. minimal: nord + dense",
        stdin: Stdin::Never,
    },
];
